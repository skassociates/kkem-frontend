      ...
      <div className="md:w-1/2 border border-[#3E3E98] rounded-xl ">
        ...
        <div className="p-9">
          ...
          <div className="mt-8 text-lg">
            ...
            proud to introduce the <span className="font-bold">CCC Leaderboard</span> to help you analyse your
            employability skills. Through a series of questions and answers, we
            would like you to embark on this journey and become a top scorer on
            the CCC Leaderboard! Complete all the required activities, earn
            maximum points, and stand a chance to be the CCC Leaderboard Topper!{" "}
            <br /> <br />
            Kindly take a few moments to read the instructions below: <br /> <br />
