...
export const studentFormvalidationSchema = yup
    .object({
        ...
        BCEST_GRADE: yup.string().required(),
...
export const institutionFormvalidationSchema = yup
    .object({
        ...
        RRCMNT_DRV_COUNT: yup.string().required("Recruitment Drive count is required"),
        PLC_DRV_JOB_OFR_COUNT: yup.string().required("Placement Drive Job offer count is required"),
        INTRN_SHP_STD_COUNT: yup.string().required("Internship Student Count is required"),
...
export const adminFormvalidationSchema = yup
    .object({
        ...
        PCT_STD_DWMS_PROF_COMP: yup.string().required("DWMS profile completion is required"),
        DWMS_HLP_DSK: yup.boolean().required("DWMS help desk setup is required"),
        // sec 3
        PCT_FY_STD_WEBNR: yup.string().required("is required"),
        PCT_STD_RSM_WRK_SHP: yup.string().required("is required"),
        KKEM_IIP: yup.boolean().required("is required"),
        PCT_STD_RCM_DRV: yup.string().required("is required"),
        PCT_STD_JOB_OFFR: yup.string().required("is required"),
